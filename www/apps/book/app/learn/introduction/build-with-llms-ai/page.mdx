...
The Claude Code plugins generally include skills, MCP server configurations, and commands. These features are available in most AI tools, so you can copy them into the necessary configuration files of your AI tool.
...
For other AI tools, refer to their documentation on how to add skills, MCP servers, and commands.
