...
Emails are essential for your ecommerce store. They allow you to communicate with customers, provide order updates, and implement marketing campaigns. However, setting up email templates and automating them can be complex and time-consuming.
...
To preview the email templates that Bloom creates for your store, click the Emails tab at the top of the project preview.
